...
function EmailAlojamientoInput({value,onChange,validation}) {
    return (
        <FormControl id="email" p={2}>
            <FormLabel fontSize="sm"  m={1}>Email de contacto</FormLabel>
            <Input name="email" value={value} onChange={onChange} type="email" placeholder="Email de contacto" size="sm" colorScheme="blue" bg="Azure"/>
